...
class EditView(discord.ui.View):
    ...
    async def start_edit(self, interaction, button):
        ...
        try:
            ...
            await notify(
                "âœ‚ï¸ Removing the final 4 seconds..."
            )
            ...
            if self.options["remove_silence"]:
                ...
                await notify(
                    "ðŸ”‡ Removing silent/non-speaking sections..."
                )
            ...
            #
            # IMPORTANT:
            # Never trim, compress, or re-encode the finished
            # video just because Discord cannot accept it.
            #
            # The exact original edited output_file is used
            # for both Discord and the Cloudflare fallback.
            # -------------------------------------------------
            ...
            try:
                ...
                # -------------------------------------------------
                #
                # The ORIGINAL edited video is shared.
                #
                # NO:
                # - trimming
                # - compression
                ...
                if download_url:
                    ...
                    await notify(
                        ...
                        "be created.\n\n"
                        "The original edited file is still saved "
                        "locally on the USB."
                    )
        except Exception as e:
...
async def start_kick_edit(message, kick_url):
    ...
    if user_id in SESSIONS:
        ...
        await message.channel.send(
            "â³ You already have an edit running. "
    ...
    try:
        ...
        await status.edit(
            content=(
                "âœ… **KICK Clip downloaded!**\n"
                f"Duration: **{duration:.1f}s**\n"
                f"{creator_line}\n"
                "ðŸŽ¬ Choose your editing options below, then press "
                "**Start Edit**."
            )
        )
        ...
        await message.channel.send(
            "ðŸŽ¬ **AUTO EDIT OPTIONS**\n\n"
            "Choose everything you want, then press **Start Edit**.\n\n"
            "Selected: **9:16 â€¢ Remove Non-Speech â€¢ Overlay**",
            view=view
        )
